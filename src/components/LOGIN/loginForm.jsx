  ...
  return (
    ...
    >
      {({ isSubmitting }) => (
        <Form>
          <div >
          <button type='button' onClick={()=> navigate("/auth/register")}className={css.loginRegisterPgBtn}>Registration</button>
          ...
          <button type='button' onClick={()=> navigate("/auth/register") } className={css.RegLoginPgBtn}>Register</button>
        </Form>
      )}
    </Formik>
